...
public class Maze implements Serializable {
	...
	/**
	 * This is used for passing the maze object to another state
	 */
	...
	/**
	 * used in android for loading maze
	 */
	public Maze() {
		// blank maze object		
	} 	
	...
	public Maze(int method)
	{
		...
		//panel = new MazePanel(context , this) ;
	...
	private void makeRobotType() {
		...
		if(robotDriverType == "Manual Driver")
			robotInt = 0;
		if(robotDriverType == "Gambler")
			robotInt = 1;
		if(robotDriverType == "Curious Gambler")
			robotInt = 2;
		if(robotDriverType == "Wall Follower")
			robotInt = 3;
		if(robotDriverType == "Wizard")
			robotInt = 4;
	...
	public void makeViews(MazePanel mazeView) {
		//cleanViews() ;
		...
		addView(new FirstPersonDrawer(Constants.VIEW_WIDTH,Constants.VIEW_HEIGHT,
				Constants.MAP_UNIT,Constants.STEP_SIZE, mazecells, seencells, 10, mazedists.getDists(), mazew, mazeh, bspRoot, this)) ;
